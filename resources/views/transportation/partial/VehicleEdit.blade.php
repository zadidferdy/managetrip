...
@section('breadcrumb', 'Transportation / Vehicle / Edit')
...
<div class="page-header">
  <div>
    ...
    <div style="font-size:13px;color:var(--text-muted);margin-top:2px;">
      <span style="font-family:'Space Mono',monospace;font-weight:700;color:var(--primary);">{{ $vehicle->plate_number }}</span>
    </div>
  </div>
    ...
    <div class="grid-3">
      ...
      <div class="form-group">
        ...
        <input type="number" name="year" class="form-control"
          value="{{ old('year', $vehicle->year) }}" min="1990" max="{{ now()->year }}" required>
...
<div class="card" style="margin-bottom:16px;">
  ...
  <div class="card-body">
    <div class="form-group">
      ...
      <select name="ownership" id="ownership" class="form-control" required>
        @foreach(['Milik Perusahaan','Sewa'] as $o)
          <option value="{{ $o }}" {{ old('ownership', $vehicle->ownership) == $o ? 'selected' : '' }}>{{ $o }}</option>
        @endforeach
      </select>
    ...
    <div id="rental-fields" class="{{ old('ownership', $vehicle->ownership) === 'Sewa' ? 'show' : '' }}">
      <div class="grid-3">
        ...
        <div class="form-group">
          ...
          <input type="date" name="rental_start" class="form-control"
            value="{{ old('rental_start', $vehicle->rental_start?->format('Y-m-d')) }}">
        ...
        <div class="form-group">
          ...
          <input type="date" name="rental_end" class="form-control"
            value="{{ old('rental_end', $vehicle->rental_end?->format('Y-m-d')) }}">
    ...
    <div class="grid-2">
      ...
      <div class="form-group">
        ...
        <input type="number" name="last_service_km" class="form-control"
          value="{{ old('last_service_km', $vehicle->last_service_km) }}" min="0">
